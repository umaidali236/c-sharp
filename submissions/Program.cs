...
Console.WriteLine(" I am motivated to learn C# because it is a versatile and powerful language that is in high demand in the software industry.Learning C# will help expand my skill set and open up various career opportunities in the industry.");
